...
appLabel = tk.Label(root, text="Student Management System", fg="#06a099", width=34)
appLabel.config(font=("Sylfaen", 32))
appLabel.grid(row=0, columnspan=2, padx=(10,10), pady=(25, 0))
